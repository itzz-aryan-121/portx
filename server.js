...
mongoose
  .connect(
    "mongodb+srv://vishdisha005:dishameet@cluster0.twa5cms.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
  )
  ...
  try {
    ...
    if (count === 0) {
      const resumeData = {
        ...
        objective:
          "As an aspiring Full Stack Developer with a strong foundation in HTML, CSS, JavaScript, ReactJS, Node.js, and MongoDB etc. My goal is to design and develop user-centric applications that provide seamless user experiences.",
        education: [
          {
        ...
        projects: [
          {
            ...
            description:
              "Developed to track the live location of devices in real-time, providing enhanced monitoring capabilities.",
            isLive: true,
          },
          {
            name: "QR-Code Generator",
            description:
              "Build QR Code Generator that does something and had quantified success which i made using MERN Stack.",
            isLive: true,
          },
          {
            name: "Boom App",
            description:
              "Designed to enable seamless and secure video communication between users, suitable for virtual meetings, interviews, and collaboration.",
            isLive: true,
          },
        ],
        activities: [
